...
const p5risk=execution.createState();
p5risk.config.account=1000;p5risk.config.riskPct=1;
const overRisk=await execution.marketGate({symbol:"BTCUSDT",side:"LONG",entry:100,stop:90,target:120,qty:2},p5risk);
assert(!overRisk.allowed&&overRisk.reason==="PER-TRADE RISK EXCEEDED","phase5 per-trade risk cap");
